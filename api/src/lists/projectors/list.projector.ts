...
import { CreateListOperation } from '../operations/list/create-list.operation';
import { DeleteListOperation } from '../operations/list/delete-list.operation';
import { FinishShoppingOperation } from '../operations/list/finish-shopping.operation';
import { StartShoppingOperation } from '../operations/list/start-shopping.operation';
